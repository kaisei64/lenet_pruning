...
for count in range(1, inv_prune_ratio + 9):
    ...
    # パラメータの保存
    if count == 6:
        parameter_save('./result2/pkl1/dense_conv_prune_dense99per_conv60per.pkl', new_net)
        parameter_save('./result2/pkl1/dense_conv_prune_dense99per_conv60per_copy.pkl', new_net)
    elif count == 8:
        ...
        parameter_save('./result2/pkl1/dense_conv_prune_dense99per_conv94per.pkl', new_net)
        parameter_save('./result2/pkl1/dense_conv_prune_dense99per_conv94per_copy.pkl', new_net)
        break
    else:
        pass
